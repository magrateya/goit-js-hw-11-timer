  ...
  _createClass(CountdownTimer, [{
    ...
    value: function start() {
      ...
      setInterval(function () {
        ...
        var time = _this.getTimeComponents(deltaTime); // this.updateClockface(time);
...
},{"../styles.css":"styles.css"}],"index.js":[function(require,module,exports) {
"use strict";

require("./js/timer");
},{"./js/timer":"js/timer.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
